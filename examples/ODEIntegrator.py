...
#        ode = MyODEPolynomial([ 10.2, -7.42, -2.1, 1. ] )
    ...
    plt.plot(tvalues,yvaluesEuler,'g',label='Euler Results')
    plt.plot(tvalues,yvaluesRK0,'y-',label='RK Results')
    plt.plot(tvalues,yvaluesRK,'b--',label='RK Results')
    plt.plot(tvalues,yexact,'ro',label='Exact Results')
    plt.show()
